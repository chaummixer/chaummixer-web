...
const Table = () => {
    ...
    <div>100 sat {" "} <FontAwesomeIcon icon="check" style={{ color: 'green'}}/></div>
        ...
        <div>
            <div>Instant tx</div>
            <div><FontAwesomeIcon icon="check" style={{ color: 'green'}}/> chaummixer direct</div>
            <div><FontAwesomeIcon icon="times" style={{ color: 'red'}}/></div>
        </div>
        <div>
            <div>Lightning</div>
            <div><FontAwesomeIcon icon="check" style={{ color: 'green'}}/> chaummixer lightning</div>
            <div><FontAwesomeIcon icon="times" style={{ color: 'red'}}/></div>
        </div>
        <div>
...
export default function Whychaummixer() {
     ...
     return (    
        ...
        <div className="index-notice">
            <h2>Released!</h2>
            <p>
                The chaummixer.com domain was acquired from monsterbyte.io and will be used for an exciting new crypto wallet.
            </p>
        </div>
        <h2>Why chaummixer?</h2>
