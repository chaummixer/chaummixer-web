        ...
        <SectionDiv>
            <Row>
                <Col sm="12" md={{ size: 10, offset: 1 }}>
                    ...
                    <hr />
                    <p>
                        chaummixer works similar to a gift card provider. Instead of gift cards, chaummixer provides you with coins, which you can trade for bitcoin.
                        However, instead of taking a fee when conversing, as most gift card providers do, chaummixer will once in a while reclaim all the "dead" gift cards (coins) which have yet to be used.
                    ...
                    <p>
                        ...
                        The most significant one is already addressed above: over time, through entropy, people will lose access to their chaummixer wallet, forget about it, or have other reasons that prohibit them from accessing their coins again. Given enough time, this could accumulate to relatively large sums of money.
                    </p>
                    ...
                    <hr />
                    <p>
                    Considering the fact that chaummixer does not rely on fees from outgoing transactions or hookins to make a profit, we can offer extremely competitive fee rates, better than any exchange could conceivably do. 
                    Not only is this advantageous for the client: (e, <i>you!</i>), but this allows chaummixer, despite the fact that it consists of centralized entities, to be enourmously superior to other <i>(decentralized) </i> wallets in a vast number of aspects.
                    </p>
