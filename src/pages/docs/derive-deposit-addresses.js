...
export default function() {
  return (
      ...
      <p>
        ...
        equivalent to an <code>xpub</code> in bip32. The chaummixer wallet exposes its <em>address generator</em> public key, so it makes it easy to generate (and check) you're generating compatible addresses.
      </p>
      <p>
...
mp.Buffutils.toHex(addressGenerator.buffer);` }
      ...
      <p>
        This functionality is packaged up in the chaummixer library as <code>.derive</code> function on a PublicKey. (TODO: link to impl detail). This works on arbitrary sized integers (and buffers). You can even try really big numbers like: <code>1234567890000000000000000000000n</code>
      </p>
      <p>
