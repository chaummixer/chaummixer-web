...
const LoadCoins = () => { 
    ...
    const getData = () => fetch(`https://testnet.chaummixer.dev`).then((res) => res.status === 200 ? res.json() : null).catch(error => alert(error.message));
    ...
    <Col sm="12" md={{ size: 10, offset: 1 }}>
        <h1>Coins</h1>
        <p>
            There are exactly 32 different coins in chaummixer, each having a different <strong>magnitude</strong>
        </p>
        <p>
            Here is an example from our testnet custodian: (https://testnet.chaummixer.dev)
        </p>
        <table>
            <thead>
                <tr>
        ...
        <SectionDiv>
            <Row>
                <Col sm="12" md={{ size: 10, offset: 1 }}>
                    ...
                    <hr />
                    <p>
                        chaummixer uses a <a href="https://en.wikipedia.org/wiki/Schnorr_signature">schnorr</a> <a href="https://en.wikipedia.org/wiki/Blind_signature" target="_blank" rel="noopener noreferrer">blind signatures</a>{' '}
                        ...
                        to use. And at any time they can be converted back to regular bitcoin. Using chaummixer is quite simply the cheapest and most private way to use bitcoin.
                    </p>
                    ...
                    <p>
                        A hookin (aka pegin) is the process of converting bitcoin into chaummixer coins. With a little eliptical curve magic, we can generate
                    ...
                    <p>
                        ...
                        batch transations (when appropriate). For this reason, using chaummixer as a bitcoin wallet is typically <em>signficantly</em> cheaper than using a
                        traditional wallet. 
                    </p>
