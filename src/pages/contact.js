        ...
        <SectionDiv>
            <Row>
                <Col sm="12" md={{ size: 10, offset: 1 }}>
                    ...
                    <hr />
                    <p>
                        For support requests related to the wallet or its affiliated custodians, you can send an email to <a href="mailto:chaummixer@protonmail.com?Subject=Support%20Request">chaummixer@protonmail.com</a> 
                    </p>
                    <p>
